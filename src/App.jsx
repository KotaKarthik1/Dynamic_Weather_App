...
//   return (
//     <div
//       className={`bg-gradient-to-br shadow-xl shadow-gray-400 ${formatBackground()} p-10 md:p-20 mx-auto w-full`}
//     >
...
//             {/* Full Forecast Button/Accordion */}
//             <div className="flex flex-row items-center justify-center">
//               <button
//                 type="button"
//                 className="m-6 bg-white text-black border focus:ring-5 focus:outline-none focus:ring-white-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
//                 onClick={() => setShowFullForecast(!showFullForecast)}
//               >
//                 View Full Forecast
//               </button>
